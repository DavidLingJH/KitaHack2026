...
class _RecipeGeneratorState extends State<RecipeGenerator> {
  ...
  // --- 2. RECIPE SPECIFICS ---
  final TextEditingController mealType = TextEditingController();     // e.g. Breakfast, Snack
  final TextEditingController cuisine = TextEditingController();      // e.g. Italian, Spicy
  final TextEditingController servingSize = TextEditingController();  // e.g. 2 People
  final TextEditingController prepTime = TextEditingController();     // e.g. 15 Mins
  final TextEditingController appliances = TextEditingController();   // e.g. Air Fryer, Microwave
  final TextEditingController dietary = TextEditingController();      // e.g. Keto, Low Carb
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text("The Basics", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
              ...
              const Text("The Vibe", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
              const SizedBox(height: 15),
              Row(
                children: [
                  Expanded(child: GlassTextField(label: "Meal Type", controller: mealType, hint: "Dinner")),
                  const SizedBox(width: 10),
                  Expanded(child: GlassTextField(label: "Cuisine", controller: cuisine, hint: "Spicy")),
                ],
              ),
              const SizedBox(height: 10),
              // Appliances are critical for single recipes (e.g. "I only have an air fryer")
              GlassTextField(label: "Appliances", controller: appliances, hint: "Stove, Air Fryer..."),
              ...
              Row(
                children: [
                  Expanded(child: GlassTextField(label: "Servings", controller: servingSize, keyboardType: TextInputType.number)),
                  const SizedBox(width: 10),
                  Expanded(child: GlassTextField(label: "Time (mins)", controller: prepTime, keyboardType: TextInputType.number)),
                ],
              ),
              ...
              GlassTextField(label: "Dietary Needs", controller: dietary, hint: "Vegan, Gluten Free..."),
              const SizedBox(height: 10),
              ...
              SwitchListTile(
                title: const Text("Prioritize Healthy Options", style: TextStyle(fontWeight: FontWeight.w600)),
                value: isHealthy,
                // Use activeTrackColor for the "fill" color when ON
                activeTrackColor: Colors.lightGreen, 
                // Optionally set the thumb (circle) color to white for better contrast
